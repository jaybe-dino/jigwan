...
> **이사·자취를 앞둔 2030**이 풍수지리를 어렵지 않게, 재미로 접근하는 모바일 웹.
> 주소만 넣으면 AI가 실제 지형·도로·건물 데이터로 그 집 터를 봐주고,
> 전문용어 대신 **쉬운 말로 해석**해준다.
>
> *"이 집, 나랑 잘 맞을까?"*
>
> 타깃: 이사·자취 앞둔 2030(메인) · 저점 매수 고민 3040. 톤: 친근·가볍게·공유하고 싶게.
